...
export default function DashboardLayout() {
  ...
  const getDefaultLayouts = useCallback(
    (widgetLabels: string[], items: DashboardWidgetProps[]): any => {
  ...
  useEffect(() => {
    if (availableWidgets.loaded) {
      ...
      if (hasCustomWidgets) {
        ...
        const defaultWidgetLabels = getDefaultWidgetLabels(
          availableWidgets.items
        );
        setLayouts(
          getDefaultLayouts(defaultWidgetLabels, availableWidgets.items)
        );
        setWidgets(
          availableWidgets.items.filter((widget) =>
